...
def o_shape(modules, script_params):
    ...
    modules['lgns'][8][1][2][0] = 0.7 #script_params[3]
    modules['lgns'][8][1][3][0] = 0.7 #script_params[3]
    modules['lgns'][8][1][4][0] = 0.7 #script_params[3]
    modules['lgns'][8][1][5][0] = 0.7 #script_params[3]
    modules['lgns'][8][1][6][0] = 0.7 #script_params[3]
    modules['lgns'][8][1][7][0] = 0.7 #script_params[3]
    modules['lgns'][8][2][7][0] = 0.7 #script_params[3]
    modules['lgns'][8][3][7][0] = 0.7 #script_params[3]
    modules['lgns'][8][4][7][0] = 0.7 #script_params[3]
    modules['lgns'][8][5][7][0] = 0.7 #script_params[3]
    modules['lgns'][8][6][7][0] = 0.7 #script_params[3]
    modules['lgns'][8][6][6][0] = 0.7 #script_params[3]
    modules['lgns'][8][6][5][0] = 0.7 #script_params[3]
    modules['lgns'][8][6][4][0] = 0.7 #script_params[3]
    modules['lgns'][8][6][3][0] = 0.7 #script_params[3]
    modules['lgns'][8][6][2][0] = 0.7 #script_params[3]
...
def O_shape(modules, script_params):
    ...
    # insert the inputs stimulus into LGN and see what happens
    # the following stimulus is an 'O' shape
    modules['lgns'][8][3][2][0] = 0.7 #script_params[3]    
...
def L_shape(modules, script_params):
    """
    generates a L-shaped visual input to neural network with parameters given"
    good intensity is about .6125
    """
    modules['atts'][8][0][0][0] = script_params[1]
    ...
    # L Stimulus: 17 units
    # edge		
    modules['lgns'][8][0][0][0] = 0.65 #script_params[3]
    modules['lgns'][8][0][1][0] = 0.65 #script_params[3]
    modules['lgns'][8][0][2][0] = 0.65 #script_params[3]
    modules['lgns'][8][0][3][0] = 0.65 #script_params[3]
    modules['lgns'][8][0][4][0] = 0.65 #script_params[3]
    modules['lgns'][8][0][5][0] = 0.65 #script_params[3]
    modules['lgns'][8][0][6][0] = 0.65 #script_params[3]
    modules['lgns'][8][0][7][0] = 0.65 #script_params[3]
    modules['lgns'][8][0][8][0] = 0.65 #script_params[3]
    # bottom
    modules['lgns'][8][1][8][0] = 0.65 #script_params[3]
    modules['lgns'][8][2][8][0] = 0.65 #script_params[3]
    modules['lgns'][8][3][8][0] = 0.65 #script_params[3]
    modules['lgns'][8][4][8][0] = 0.65 #script_params[3]
    modules['lgns'][8][5][8][0] = 0.65 #script_params[3]
    modules['lgns'][8][6][8][0] = 0.65 #script_params[3]
    modules['lgns'][8][7][8][0] = 0.65 #script_params[3]
    modules['lgns'][8][8][8][0] = 0.65 #script_params[3]	
...
def E_shape(modules, script_params):
    ...
    # insert the inputs stimulus into LGN and see what happens
    # E Stimulus: 17 units
    modules['lgns'][8][0][2][0] = 0.675 #script_params[3]
    modules['lgns'][8][0][3][0] = 0.675 #script_params[3]
    modules['lgns'][8][0][4][0] = 0.675 #script_params[3]
    # middle
    modules['lgns'][8][4][2][0] = 0.675 #script_params[3]
    modules['lgns'][8][4][3][0] = 0.675 #script_params[3]
    modules['lgns'][8][4][4][0] = 0.675 #script_params[3]
    # bottom
    modules['lgns'][8][8][2][0] = 0.675 #script_params[3]
    modules['lgns'][8][8][3][0] = 0.675 #script_params[3]
    modules['lgns'][8][8][4][0] = 0.675 #script_params[3]
    # stem
    modules['lgns'][8][0][1][0] = 0.675 #script_params[3]
    modules['lgns'][8][1][1][0] = 0.675 #script_params[3]
    modules['lgns'][8][2][1][0] = 0.675 #script_params[3]
    modules['lgns'][8][3][1][0] = 0.675 #script_params[3]
    modules['lgns'][8][4][1][0] = 0.675 #script_params[3]
    modules['lgns'][8][5][1][0] = 0.675 #script_params[3]
    modules['lgns'][8][6][1][0] = 0.675 #script_params[3]
    modules['lgns'][8][7][1][0] = 0.675 #script_params[3]
    modules['lgns'][8][8][1][0] = 0.675 #script_params[3]
...
def random_shape_o_Hi(modules, script_params):
    ...
    for k1 in range(len(script_params[5])):
        modules['lgns'][8][script_params[5][k1][0]][script_params[5][k1][1]][0] = 0.7 #script_params[3]
...
def random_shape_T_Hi(modules, script_params):
    ...
    for k1 in range(len(script_params[6])):
        modules['lgns'][8][script_params[6][k1][0]][script_params[6][k1][1]][0] = 0.7 #script_params[3]
...
def random_shape_trident_Hi(modules, script_params):
    ...
    for k1 in range(len(script_params[6])):
        modules['lgns'][8][script_params[6][k1][0]][script_params[6][k1][1]][0] = 0.65 #script_params[3]
# ------------------------------------------------------------------------
...
def intertrial_interval(modules, script_params):
    ...
    for x in range(modules['efd1'][0]):
        for y in range(modules['efd1'][1]):
            modules['efd1'][8][x][y][0] = .1 #script_params[2]
            modules['dpd1'][8][x][y][0] = .1 #script_params[2]
            modules['spd1'][8][x][y][0] = .1 #script_params[2]
	    modules['efd2'][8][x][y][0] = .1 #script_params[2]
            modules['dpd2'][8][x][y][0] = .1 #script_params[2]
            modules['spd2'][8][x][y][0] = .1 #script_params[2]
...
# this is a long trial with a block of matches and a (longer) block of non-matches
simulation_events = {        
       	'3600':	T_shape_LA,
	'3800':	delay_period,
	'7200':	T_shape_LA,
	...
	'12400':T_shape_LA,
	'12600':delay_period,
	'16000':cross_shape_LA,
	'16200':end_trial,
	'16600':intertrial_interval,
	'21200':cross_shape_LA,
	'21400':delay_period,
	'24800':cross_shape_LA,
	'25000':end_trial,
	'25400':intertrial_interval,
	'30000':cross_shape_LA,
	'30200':delay_period,
	'33600':T_shape_LA,
	'33800':end_trial,
	'34200':intertrial_interval
}
